...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAA7kLpidc:APA91bG574FEP8BBaN_RHvkq2Ym-16eS5oVofTO_tTgMa9VYaHpunFQmoyHGEW1q0z6JyuiUWeShqZ-1JpavzgimfWlRotyI0mmfzb_nt3MlXHPTZiaG6NqmDws69zh_WfyhVRB-nv6l";
    ...
    public FcmNotificationBuilder receiverUid(String receieverUid) {
        mReceiverUid = receieverUid;
        return this;
    }
    ...
    public void send() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Log.e(TAG, "onResponse: " + response.body().string() + " " + response.message().toString());
            }
        });
    }
